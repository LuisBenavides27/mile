    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 xl:w-11/12">
            <div class="py-3 text-center">
                <h1 class="text-4xl font-bold font-mono">ESTE ES EL NIVEL 1</h1>
            </div>
            @if (session('danger'))
                ...
                <div class="p-6 text-gray-900 lg:flex lg:items-center">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12 md:col-span-8">
                            <img src="{{ asset('img/incre.jpg') }}" class="max-w-full h-auto">
                        </div>

                        <!-- Column -->
                        <div class="py-12 px-12 col-span-12 md:col-span-4 text-center relative">
                            <h1 class="text-xl mb-4">Debes investigar un poco, ¿cuánto suman el año de nacimiento del
